...
var middlewareSecret = "285c22f6-5837-4480-ab5c-4ac4cc006898";
//#endregion
...
var _page0 = () => import("./chunks/generic_Du6B4brw.mjs").then((n) => n.t);
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "285c22f6-5837-4480-ab5c-4ac4cc006898") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
